...
with open(Alice_Bob_keyFolder+"/nodeKey/Alice.pubKey", "rb") as f:
    AlicePubKey = f.read()
with open(Alice_Bob_keyFolder+"/nodeKey/Bob.pubKey", "rb") as f:
    BobPubKey = f.read()
with open(Alice_Bob_keyFolder+"/nodeKey/Alice.priKey", "rb") as f:
    AlicePriKey = f.read()
with open(Alice_Bob_keyFolder+"/nodeKey/Bob.priKey", "rb") as f:
    BobPriKey = f.read()

def new_match(AliceRating, BobRating):
    ...
    matchData[AlicePubKey]["isRadiant"] = True
    matchData[BobPubKey]["isRadiant"] = False
    if AliceRating > BobRating: matchData = [matchData, 1]
    else: matchData = [matchData, 0]
